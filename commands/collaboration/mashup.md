...
# /collaboration:mashup — Skill-backed domain mashup

## Use
- Load `skills/collaboration/mashup/SKILL.md` (skill `mashup`) and follow it.
- Keep the mashup concept format from the skill.
