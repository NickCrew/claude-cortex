...
- **`/docs:diagrams`** - Build Mermaid diagrams for documentation and system visualization
- **`/docs:teacher`** - Explain concepts and design learning paths with exercises
- **`/docs:tutorials`** - Create hands-on tutorials with progressive steps and exercises
